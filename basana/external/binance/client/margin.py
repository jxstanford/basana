...
class MarginAccount(metaclass=abc.ABCMeta):
    ...
    async def create_order(
        ...
        **kwargs: Dict[str, Any]
        ...
        return await self._client.make_request(
            "POST", "/sapi/v1/margin/order", data=params, send_sig=True
        )
    ...
    async def query_order(
        ...
        return await self._client.make_request(
            "GET", "/sapi/v1/margin/order", qs_params=params, send_sig=True
        )
    ...
    async def get_open_orders(self, symbol: Optional[str] = None) -> dict:
        ...
        return await self._client.make_request(
            "GET", "/sapi/v1/margin/openOrders", qs_params=params, send_sig=True
        )
    ...
    async def cancel_order(
        ...
        return await self._client.make_request(
            "DELETE", "/sapi/v1/margin/order", qs_params=params, send_sig=True
        )
    ...
    async def get_trades(
        ...
        return await self._client.make_request(
            "GET", "/sapi/v1/margin/myTrades", qs_params=params, send_sig=True
        )
    ...
    async def create_oco(
        ...
        **kwargs: Dict[str, Any]
        ...
        params.update(kwargs)
        return await self._client.make_request(
            "POST", "/sapi/v1/margin/order/oco", data=params, send_sig=True
        )
    ...
    async def query_oco_order(
        ...
        assert (order_list_id is not None) ^ (
            client_order_list_id is not None
        ...
        return await self._client.make_request(
            "GET", "/sapi/v1/margin/orderList", qs_params=params, send_sig=True
        )
    ...
    async def cancel_oco_order(
        ...
        return await self._client.make_request(
            "DELETE", "/sapi/v1/margin/orderList", data=params, send_sig=True
        )
...
class CrossMarginAccount(MarginAccount):
    ...
    async def transfer_from_spot_account(self, asset: str, amount: Decimal) -> dict:
        ...
        return await self._client.make_request(
            "POST", "/sapi/v1/margin/transfer", send_sig=True, data=params
        )
    ...
    async def get_account_information(self) -> dict:
        return await self._client.make_request(
            "GET", "/sapi/v1/margin/account", send_sig=True
        )
...
class IsolatedMarginAccount(MarginAccount):
    ...
    async def transfer_from_spot_account(
        self, asset: str, symbol: str, amount: Decimal
    ) -> dict:
        params: Dict[str, Any] = {
            "asset": asset,
            "symbol": symbol,
        ...
        return await self._client.make_request(
            "POST", "/sapi/v1/margin/isolated/transfer", send_sig=True, data=params
        )
    ...
    async def get_account_information(self) -> dict:
        return await self._client.make_request(
            "GET", "/sapi/v1/margin/isolated/account", send_sig=True
        )
