...
class SpotAccount:
    ...
    async def create_order(
        ...
        **kwargs: Dict[str, Any]
        ...
        return await self._client.make_request(
            "POST", "/api/v3/order", data=params, send_sig=True
        )
    ...
    async def query_order(
        ...
        return await self._client.make_request(
            "GET", "/api/v3/order", qs_params=params, send_sig=True
        )
    ...
    async def get_open_orders(self, symbol: Optional[str] = None) -> dict:
        ...
        return await self._client.make_request(
            "GET", "/api/v3/openOrders", qs_params=params, send_sig=True
        )
    ...
    async def cancel_order(
        ...
        return await self._client.make_request(
            "DELETE", "/api/v3/order", qs_params=params, send_sig=True
        )
    ...
    async def get_trades(
        ...
        return await self._client.make_request(
            "GET", "/api/v3/myTrades", qs_params=params, send_sig=True
        )
    ...
    async def create_oco(
        ...
        **kwargs: Dict[str, Any]
        ...
        params.update(kwargs)
        return await self._client.make_request(
            "POST", "/api/v3/order/oco", data=params, send_sig=True
        )
    ...
    async def cancel_oco_order(
        ...
        return await self._client.make_request(
            "DELETE", "/api/v3/orderList", data=params, send_sig=True
        )
    ...
    async def query_oco_order(
        ...
        return await self._client.make_request(
            "GET", "/api/v3/orderList", qs_params=params, send_sig=True
        )
