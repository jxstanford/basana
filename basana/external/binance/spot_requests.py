...
class MarketOrder(ExchangeOrder):
    def __init__(
        ...
        **kwargs: Dict[str, Any]
        ...
        ), "Either amount or quote_amount should be set"
        super().__init__(
    ...
    async def create_order(self, spot_account_cli) -> dict:
        return await spot_account_cli.create_order(
            helpers.pair_to_order_book_symbol(self._pair),
...
class OCOOrder:
    def __init__(
        ...
        **kwargs: Dict[str, Any]
        ...
        self._stop_limit_time_in_force = (
            None if stop_limit_price is None else stop_limit_time_in_force
        )
