...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {
                "id": "16422505508",
                "datetime": datetime.datetime(2022, 12, 14, 2, 47, 39, 521000).replace(
        ...
        (
            ...
            {
                "id": "12010477623",
                "datetime": datetime.datetime(2022, 12, 16, 19, 6, 14, 815000).replace(
                    tzinfo=datetime.timezone.utc
                ),
                "client_order_id": "E1547A6979EA49A9A849A457BD751D38",
                "limit_price": None,
        ...
        (
            ...
            {
                "id": "3286471275",
                "datetime": datetime.datetime(2022, 12, 16, 23, 13, 14, 634000).replace(
                    tzinfo=datetime.timezone.utc
                ),
                "client_order_id": "76168451F9EE4C9DAADC16D74B874E4B",
            },
...
def test_create_order(
    ...
    binance_http_api_mock.post(
        re.compile(r"http://binance.mock/sapi/v1/margin/order\\?.*"),
        status=200,
...
def test_order_info(
    ...
    binance_http_api_mock.get(
        re.compile(r"http://binance.mock/sapi/v1/margin/myTrades\\?.*"),
        status=200,
    ...
    [
        (
            ...
            ],
            {
                ...
                "status": "NEW",
                "time_in_force": "GTC",
                "datetime": datetime.datetime(2023, 2, 15, 19, 3, 48, 466000).replace(
                    tzinfo=datetime.timezone.utc
                ),
                "type": "LIMIT",
            },
...
def test_get_open_orders(
    ...
    binance_http_api_mock.get(
        re.compile(r"http://binance.mock/sapi/v1/margin/openOrders\\?.*"),
        status=200,
    ...
    [
        (
            ...
            },
            {
                ...
                "datetime": datetime.datetime(2022, 12, 14, 2, 54, 27, 587000).replace(
                    tzinfo=datetime.timezone.utc
                ),
                "is_open": True,
...
def test_create_oco_order(
    ...
    binance_http_api_mock.post(
        re.compile(r"http://binance.mock/sapi/v1/margin/order/oco\\?.*"),
        status=200,
        payload=response_payload,
    )
...
def test_oco_order_info(
    ...
    binance_http_api_mock.get(
        re.compile(r"http://binance.mock/sapi/v1/margin/orderList\\?.*"),
        status=200,
        payload=response_payload,
    )
    ...
    [
        (
            ...
            CANCEL_OCO_ORDER_RESPONSE_79680111,
            {
                ...
                "datetime": datetime.datetime(2022, 12, 19, 15, 24, 35, 963000).replace(
                    tzinfo=datetime.timezone.utc
                ),
                "is_open": False,
            },
...
def test_transfer(binance_http_api_mock, binance_exchange):
    async def test_main():
        ...
        assert (
            await binance_exchange.cross_margin_account.transfer_from_spot_account(
                "USDT", Decimal("100")
            )
        )["tranId"] == 124735427615
        assert (
            await binance_exchange.cross_margin_account.transfer_to_spot_account(
                "USDT", Decimal("100")
            )
        )["tranId"] == 124735427615
